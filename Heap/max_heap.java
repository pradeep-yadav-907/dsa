...
public class max_heap {
    static class Heap {
        ...
        public void add(int data) {
            ...
            while (index > 0 && arr.get(index) > arr.get(par)) {      // Agar child parent se bada ho, to swap karo
        ...
        public int peek() {        // root node
            return arr.get(0); // Heap ka sabse bada element root pe hota hai, jo index 0 pe hota hai.
        }
